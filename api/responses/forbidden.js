...
module.exports = function forbidden (data, options) {
  ...
  console.log("data"+data + "options" + options+"req"+req,"res"+res);
  ...
  // work, just send JSON.
  if (options.view) {
    console.log('wants just send json');
  ...
  // but fall back to sending JSON(P) if any errors occur.
    ...
    console.log('wants second argument');
